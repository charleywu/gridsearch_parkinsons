...
```{r}
# regression: prediction error as function of clinial variables
...
tab_model(lm_error_PD_only_BDI_MMSE_HY, title = "Regression results: Prediction error of PD patients in bonus round as function of BDI, MMSE, and Hoehn-Yahr score.")
