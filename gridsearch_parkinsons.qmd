...
ggsave("plots/decision_latency.png", dpi=300, width=9, height=4)
```
...
ggsave("plots/S2_bonusround_judgment_error.png", p_bonusround_prediction_error, dpi=300, height = 5, width = 6 )
...
ggsave("plots/S3_bonusround_regression_judgment_error_confidence.png", dpi=300, height = 4, width = 7 )
...
p_model_simulation_params
ggsave("plots/S6_model_simulation_params_lambda_0_5.png", p_model_simulation_params, bg="white", width = 14, height = 5, dpi = 300)
