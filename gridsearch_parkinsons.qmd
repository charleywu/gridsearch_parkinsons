---
title: "Exploration and Exploitation in Parkinson’s Disease"
author: 
  - name: Björn Meder
...
#| fig-cap: "Performance landscape generated from simulations with the GP-UCB model. The amount of generalization was fixed to lambda=1 (the true amount of spatial correlation in the task) and beta and tau were varied. Dots represent participant means cross-validated value; the larger markers indicate the median of each group."
#| fig-width: 12
#| fig-height: 4
...
#get data
sim  <-  read.csv('modelResults/simulatedModels_means_lambda_1_0.csv') 
...
```{r}
#| fig-label: fig-bonusround-chosen-reward
...
#| fig-cap: "Performance landscape of the GP-UCB model across different amounts of random exploration tau and uncertainty-directed exploration beta. The amount of generalization was fixed to lambda=0.5 and beta and tau were varied between exp(-4) and exp(5), with 1000 simulated learners per parameter combination. Each dot shows one participant; the larger markers indicate the group median."
#| fig-width: 12
#| fig-height: 4
...
#get data
sim  <-  read.csv('modelResults/simulatedModels_means_lambda_0_5.csv') 
