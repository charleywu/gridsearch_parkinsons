...
bfformat <- function(val, maxValue = 100){
  if (val>maxValue){ #If larger than max value, just go with BF>maxValue
    out <- paste0('>',maxValue)
...
#Note BM: changed nIter from 10 to 100 on March 26 2020
sampleGibbsTwoSample <- function(x, y, n1, n2, nIter = 100, rscale = 1/sqrt(2)) {
