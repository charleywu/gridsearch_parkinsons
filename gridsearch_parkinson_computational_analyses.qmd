---
title: "Gridsearch Parkinson: Computational Analyses"
author: 
  - Björn Meder
  - Martha Sterf
  - Charley M. Wu
...
We conducted model-based analyses to gain a more comprehensive understanding of participants' learning, exploration, and decision-making processes. We analyze patients' behavior through the lens of the Gaussian Process Upper Confidence Bound (GP-UCB) model, which in previous research using the same paradigm has provided the best account
...
2. a _sampling strategy_, which uses the reward predictions to evaluate how promising each option is, and
